                         ...
                         <form method="POST" enctype="multipart/form-data">
                             <div class="card-body">
                                 ...
                                 <div class="form-group">
                                     ...
                                     <input type="text" class="form-control" id="exampleInputstatus_orderName1" placeholder="Tên trạng thái đơn hàng" name="status_order_name" value="<?=$status_order['status_order_name'] ?>">
                                     <span></span>
                                 </div>
                             </div>
                     </div>

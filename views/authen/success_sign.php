        ...
        <div class="row justify-content-center">
            <div class="col-md-8 col-lg-6">
                <div class="notification-box text-center">
                    ...
                    <h3 class="mb-3">Bạn đã đăng kí thành công</h3>
                    <p class="mb-4">Vui lòng đăng nhập lại với tài khoản và mật khẩu của bạn</p>
                    <a href="<?=BASE_URL.'?act=login'?>" class="btn btn-primary p-3" >Về trang đăng nhập</a>
                </div>
            </div>
        </div>
    </div>
